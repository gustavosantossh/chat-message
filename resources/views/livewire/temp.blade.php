    ...
    <div>
        ...
        {{-- {{dd($contacts->UserHasContacts[0]->id)}} --}}
            ...
            <div class="flex mb-3">
                ...
                <button wire:confirm="Deseja deletar este contato?" wire:click="deleteContact({{$contact->id}})" class="w-16 m-3 p-4 bg-red-600 rounded-md text-center align-items-center">
